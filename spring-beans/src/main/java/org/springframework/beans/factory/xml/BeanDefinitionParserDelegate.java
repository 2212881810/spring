...
public class BeanDefinitionParserDelegate {
	...
	public AbstractBeanDefinition parseBeanDefinitionElement(
		...
		try {
			...
			// 后面都是一堆解析属性的方法，然后将解析出来的属性值set到beanDefinition中去
	...
	/**
	 * 将bean的其它定义的属性解析出来，然后set到beanDefinition实例中去
	 * <p>
	...
	public void parseConstructorArgElement(Element ele, BeanDefinition bd) {
		/**
		 * <bean id="school" class="qinfeng.zheng.component.School">
		 * 		<constructor-arg index="0" value="100"/>
		 * 		<constructor-arg index="1" value="小学"/>
		 * 	</bean>
		 */
		String indexAttr = ele.getAttribute(INDEX_ATTRIBUTE);  // 使用index 方式配置构造器参数

		/**
		 *		<constructor-arg type="java.lang.Integer" value="100"/>
		 * 		<constructor-arg type="java.lang.String" value="小学"/>
		 */
		String typeAttr = ele.getAttribute(TYPE_ATTRIBUTE);  //使用类型 方式配置构造器参数

		/**
		 * 		<constructor-arg name="id" value="100"/>
		 * 		<constructor-arg name="name" value="小学"/>
		 */
		String nameAttr = ele.getAttribute(NAME_ATTRIBUTE); // 使用name 方式 配置构造 器参


		// spring 默认首选是使用index方式构造器
		...
		} else { // 使用name ,type 类型构造器进入下面这个分支
			try {
